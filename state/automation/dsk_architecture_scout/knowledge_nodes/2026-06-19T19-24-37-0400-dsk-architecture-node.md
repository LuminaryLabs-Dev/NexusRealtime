# Knowledge Nodes: dsk_architecture_scout 2026-06-19T19-24-37-0400

## Root Lesson
- id: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
- statement: DSK remains release-aligned and smoke-green, and the newest registry/surface/SequenceNode findings add a read-model/orchestration isolation tranche without replacing the ordered runtime failure-boundary fixture queue.
- why it matters: Live probes still reconfirm tranche 1 DSK/runtime gaps, while neighboring lanes add core proof-surface risks where observers and orchestration flows can mutate or overcount state; both are real, but runtime failure-boundary remains the first non-scout fixture target.

## Child Nodes
- id: dsk-release-aligned-still-context-2026-06-19-1924
...
- id: dsk-runtime-failure-boundary-first-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
...
- id: dsk-lifecycle-parity-second-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
  ...
  evidence: Prior DSK and neighboring deep/domain nodes carry held-input receipts, terrain query/chunk parity, partial-start cleanup, and stopped-session state as later rows.
...
- id: dsk-query-command-semantics-third-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
...
- id: dsk-experience-edge-fourth-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
...
- id: dsk-read-model-orchestration-fifth-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
  lesson: Registry descriptors, engine surface snapshots, and SequenceNode sibling receipt semantics should join the hardening queue as a separate read-model/orchestration isolation tranche.
  evidence: Current probe found shader/material registry reads mutate caller-owned nested data, resource/event surface snapshots mutate live resource and event payload state, SequenceNode race failure leaves a sibling running under a failed parent, and SequenceNode `any` emits two child-finished receipts for one winner; source evidence includes `src/shaders.js:1-8`, `src/shaders.js:70-87`, `src/shaders.js:123-134`, `src/ecs.js:211-221`, `src/ecs.js:251-255`, `src/surfaces.js:35-45`, and `src/sequence-node.js:787-849`.
...
- id: dsk-proof-readiness-separate-layer-2026-06-19-1924
  parent: dsk-read-model-orchestration-tranche-root-2026-06-19-1924
  ...
  evidence: Ecosystem state node `2026-06-19T19-10-05-0400`, ecosystem proof node `2026-06-19T18-39-22-0400`, and domain idea node `2026-06-19T19-00-18-0400` keep local proof, fetched-ref proof, public browser proof, npm metadata, package-version policy, runtime hardening, lifecycle parity, query/command semantics, experience-edge proof, and read-model/orchestration rows separate.
...
- reason: Preserves proof-readiness queue separation while adding read-model/orchestration isolation as a distinct hardening tranche.
- source: `state/automation/deep_bug_report_scout/knowledge_nodes/2026-06-19T18-55-33-0400-deep-bug-node.md`
- relationship: extends
- reason: Adds registry descriptor isolation, surface snapshot isolation, race cleanup, and any receipt policy evidence.
- source: `state/automation/domain_kit_idea_expander/knowledge_nodes/2026-06-19T19-00-18-0400-domain-kit-idea-node.md`
- relationship: expands
- reason: Converts fresh read-model and orchestration findings into planning inventory without replacing executable runtime fixture work.
- source: `state/automation/ecosystem_state_scout/knowledge_nodes/2026-06-19T19-10-05-0400-ecosystem-state-node.md`
- relationship: constrains
- reason: Confirms module-source strategy and public proof remain separate from runtime/read-model hardening.
...
- branch: proof-boundary-separation
  ...
  question: Which proof claims are runtime hardening, lifecycle parity, query/command semantics, experience-edge proof, read-model/orchestration proof, and distribution/module-source proof?
