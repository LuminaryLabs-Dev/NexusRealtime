...
- id: public-proof-import-shape-2026-06-19-1910
  ...
  evidence: Direct fetch returned 200 for the proof route; Playwright snapshot showed heading text plus `Booting...`; console/request checks showed 404s for `NexusRealtime/src/index.js`, ProtoKits `domain-foundation`, and ProtoKits `domain-service-kits`.
